...
<select ID="ddlCountry" onChange="onCountrySelected()">
<option value="Canada">Select Emp</option>
<option value="USA" >CS100446</option>
<option value="USA" >CS100447</option>
...
<tr id="trCanada">
  <td contenteditable="true">Stir Fryf</td>
...
<br><br>
	 ...
	 <table class="table" border="3">
      <tr>
       ...
       <tr bgcolor="#FF0000">
        <td>Stir Fryfjshksjehkksgfgsdfsdgfdsh</td>
        <td >stir-fry</td>
		 <td >stir-fry</td>
		  <td >stir-fry</td>
		   <td >stir-fry</td>
 ...
 <div class="input-color">
  ...
  <p>   <div class="color-box" style="background-color: #FF0000"></div>
 &nbsp;&nbsp;&nbsp;&nbsp; ::: Design (or) Development (or) UnitTest (or) Functionality Test (or) Review state
</p>	
...
<div class="input-color">
  ...
  <p>   <div class="color-box" style="background-color: #00FF7F;"></div>
 &nbsp;&nbsp;&nbsp;&nbsp; ::: Completed state
</p>	
    <!-- Replace "#FF850A" to change the color -->
</div>
  ...
  <p>   <div class="color-box" style="background-color: #FFFF00;"></div>
 &nbsp;&nbsp;&nbsp;&nbsp; ::: assigned state
</p>	
    <!-- Replace "#FF850A" to change the color -->
</div>
