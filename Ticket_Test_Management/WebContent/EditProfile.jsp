	...
	<div class="w3l-from">
		<form action="#" method="post">	
			<div class="w3l-user">
				...
				<input type="text" name="Athlete's Name" placeholder=""   pattern="[a-zA-Z]{0,30}" 
title="enter aplhabets only max 30 characters" required="" autofocus required="">
			...
			<div class="w3l-user">
				...
				<input type="text" name="Athlete's Name" placeholder=""  readonly="readonly"required="">
			</div>
			<div class="w3l-user">
				<label class="head">Password<span class="w3l-star"> * </span></label>
				<input type="text" name="Athlete's Name"  placeholder=""  pattern="((?=.*\d)(?=.*[A-Z])(?=.*\W).{8,16})" title="password must atleast contain 
...
with min 8 and max 16 characters" required="">
			...
			<div class="w3l-mail">
				...
				<input type="email" name="email" placeholder=""  pattern="[a-z0-9._%+-]*[@]\b(gmail.com)" required="">
			</div>
			<div class="w3l-mail">
				<label class="head">Web mail<span class="w3l-star"> * </span></label>
				<input type="email" name="email"  pattern="[a-z0-9._%+-]*[@]\b((cubicitsolution.in)||(cubicitsolution.com))" placeholder="" required="">
			</div>
			<div class="w3l-user">
				<label class="head">Mobile<span class="w3l-star"> * </span></label>
				<input type="text"  name="Athlete's Name"  placeholder="" onkeypress="return AllowNumbersOnly(event)" required
