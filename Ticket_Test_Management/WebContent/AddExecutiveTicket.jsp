...
<h3 align="center" style=color:white><b>Add Ticket</b></h3>
...
<div class="w3l-from">
		<form action="#" method="post">	
			<div class="w3l-user">
				...
				<input type="text" name="Athlete's Name" placeholder=""  required="" value="TC-001">
			</div>
			<div class="w3l-rem">
				<div class="w3l-right">
			...
			<div class="w3l-user">
				...
				<input type="text" name="Athlete's Name"  placeholder="">
			</div>
			<div  class="w3l-options1">
