...
<h3 style="color:#fff;" align="center"><b>BugReport</b></h3>
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="#">Prepare BugReport</a></li>
...
<div class="card-header">
                            <b>Project Name:</b>&emsp;&emsp;&emsp;&nbsp;&nbsp;<input type="text" name="projectname"> <br><br>

							<b>Requirement Name:</b>&nbsp;&nbsp;<input type="text" name="requirementname"><br><br>
							<b>Module Name:</b>&nbsp;&emsp;&emsp;&emsp;<input type="text" name="modulename"> <br><br>
							</b>Tc-Id</b>&emsp;<select>
							<option>Tc-001</option>
							<option>Tc-002</option> 
							<option>Tc-003</option> 
							</select>&emsp;
