		...
		<section id="main-content">
			...
			<br> <b>ProjectName:::</b>
				...
				<form action="BugReport2.jsp" method="post">
					...
					<%
						PreparedStatement pstmt1 = conn.prepareStatement("select * from testreporttable");
				...
				<form>
					<div class="table-repsonsive">
						...
						<table class="table table-bordered" id="item_table">
							...
							try
							{
								PreparedStatement pstmt2 = conn.prepareStatement("select * from testreporttable where testcaseid=? and projectname=? and requirementname=? and modulename=?");
